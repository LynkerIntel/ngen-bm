...
class NoahOWP:
    ...
    def __init__(self, start_time: str, end_time: str, parameter_dir: Path):
        ...
        # NOTE: I dont think this actually matters for use w/ ngen
    ...
    def _v2_defaults(self) -> None:
        ...
        #NJF From Keith, this *might* be problematic for Noah-OM
        ...
        # non noahmp options
        #drainage option should match runoff_option
        #NJF TODO validate this on the backend, get rid of DrainageOption duplicate enum?
        drainage_option = DrainageOption.original_subsurface_runoff
        #NJF turns out this option can only be used with runoff/drainage option of 8...
        dynamic_vic_option = DynamicVicOption.philip
        crop_model_option = CropModelOption.none
        #coupling with other subsurface modules...
    ...
    def hydrofabric_linked_data_hook(
        ...
        # hydrofabric slope apepars to be in percent (ratio, 0.0-1.0) form,
        #  to convert to degress, need arctan(ratio)
        terrain_slope = math.degrees( math.atan(data['slope']) )
